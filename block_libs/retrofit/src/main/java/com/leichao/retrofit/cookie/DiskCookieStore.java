...
public class DiskCookieStore {
    ...
    public DiskCookieStore(Context context) {
    ...
    public void add(HttpUrl url, Cookie cookie) {
        ...
        prefsWriter.putString(name, encodeCookie(new DiskCookieSerializable(cookie)));
        prefsWriter.apply();
    }
     ...
     */
    protected String encodeCookie(DiskCookieSerializable cookie) {
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            cookie = ((DiskCookieSerializable) objectInputStream.readObject()).getCookies();
        } catch (IOException e) {
